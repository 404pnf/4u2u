		...
		<div class="login">
			<div id="tabs0">
				<ul class="menu0" id="menu0">
					<li onclick="setTab(0,0)" class="hover">注册登陆</li>
					<li onclick="setTab(0,1)">积分充值</li>
				</ul>
  ...
  <ul><li>线阅读电子书</li>
      ...
      <li>载共享资源</li>
		...
		<div id="huandeng_jifen"  class="top-middle">
			...
			<!--积分换礼图片-->
			<div class="ad"><a href="libao"><img src="/sites/2u4u.com.cn/themes/stable/css/fp_images/ad.gif" width="478" height="90" border="0" /></a></div>
		</div>
...
$(function(){
	...
	/* $('#yuedu_hover .view-display-id-attachment_4 .view-header').addClass('on');
