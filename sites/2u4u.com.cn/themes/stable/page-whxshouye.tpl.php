	...
	<div id="main_top" class="clearfix top"> 
		...
		<div class="login">
			...
			<div id="tabs0" class="tab_area" >
                          <ul id="menu0" class="menu0 dl-tabs">
                            <li id="tab1" class="tabs hover">注册登陆</li>
                            <li id="tab2" class="tabs">积分充值</li>
                          </ul>
       ...
       <!--积分中心标签页-->
        <div class="jifen">
					...
					<div id="tabs1" class="tab_area" >
                          ...
                          <div id="main1" class="main dl-panes clear">
							...
							<div id="pane_tab2" class="pane">
							  <ul><li><a href="http://2u4u.com.cn/chongzhi#yanzhengma">图书验证码充值</a></li>
								  <li><a href="http://2u4u.com.cn/node/63503">购买悠游网积分</a></li>-->
                                                                  <li><a href="http://2u4u.com.cn">积分充值暂时停止</li>    
								  <li><a href="http://2u4u.com.cn/chongzhi#hongdong">参与活动得积分</a></li>
							  </ul>
                            </div>
		...
		<div id="huandeng_jifen"  class="top-middle">
			...
			<!--积分换礼图片-->
			<div id="adcontainer">
				<?php $block_ad = module_invoke('block', 'block', 'view', 76); ?>
				<?php print $block_ad['content']; ?>
			</div>
		</div>
		...
		<div id="search_tuijian" class="top-right"> 
			...
			<div id="yuedu_left" class="left">
				<div id="yuedu_hover" class="dlcontent tab_area" >
                          <ul id="dl-tabs0" class="dl-tabs">
                            <li id="tab1" class="tabs active"><h3>编辑推荐</h3></li>
                            <li id="tab2" class="tabs"><h3>现在免费</h3></li>
                            <li id="tab3" class="tabs"><h3>热门排行榜</h3></li>
                          </ul>
		  ...
		  <div id= "view_shipin" class="clearfix library-bg">
			...
			<div id="shipin_right"class="newfilm">
				<div class="newfilm-head">新片热译</div>  
					<div class="media-line"></div>  
		  ...
		  <div id= "view_quiz" class="clearfix library-bg">
			...
			<div id="quiz_content">
				<div id="quiz_zhuanxiang" class="testcenter-content1">
					<h3><a href="http://quiz.2u4u.com.cn/quizwhx/1978">专项测试</a><span>——测试您的专项英语水平</span></h3>
					<div class="testestcentr-pic"><a href="http://quiz.2u4u.com.cn/quizwhx/1978" target="_blank"><img src="/sites/2u4u.com.cn/themes/stable/css/fp_images/test2.gif" border="0" /></a></div>
				...
				<div id="quiz_kaoshi" class="testcenter-content1">
					<h3><a href="http://quiz.2u4u.com.cn/quizwhx/8587">考试测试</a><span>——考试临近，来摸底测试吧</span></h3>
					<div class="testestcentr-pic"><a href="http://quiz.2u4u.com.cn/quizwhx/8587" target="_blank"><img src="/sites/2u4u.com.cn/themes/stable/css/fp_images/test3.gif" border="0" /></a></div>
					<div class="testcenter-list">
				...
				<div id="quiz_quwei" class="testcenter-content1">
					<h3><a href="http://quiz.2u4u.com.cn/quizwhx/1977">趣味测试</a><span>——测试万花筒</span></h3>
					<div class="testestcentr-pic"><a href="http://quiz.2u4u.com.cn/quizwhx/1977" target="_blank"><img src="/sites/2u4u.com.cn/themes/stable/css/fp_images/test4.gif" border="0" /></a></div>
					<div class="testcenter-list">
  ...
  <div class="qz-bg">
			...
			<div class="qz-ywyd"><!--有问有答-->		
				...
				<div class="qz-ywyd-text"> 
					...
					<? print phptemplate_get_answer('whx_frontpage','default');?>
				</div>
			</div>
		  </div>
...
function tabs_hover(tab_area) {
        ...
        hl.mouseover(function() {
			...
			$(tab_area+" #pane_"+this.id).addClass("on");
