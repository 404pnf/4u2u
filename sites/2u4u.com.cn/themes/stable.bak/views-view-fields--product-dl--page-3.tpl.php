...
//$price_num = stable_dl_sellprice($fields);
$price_num = stable_dl_sellprice($fields['sell_price']->handler);
if($price_num==5)
{
	 print ' 
	 <div id="mobile1_gundong" class="gundong">
		<span class="title"> <a href="/dlprice/2" target="_blank">其他5元产品 </a></span>
