  ...
  <div id="page"><div id="page-inner">
    ...
    <?php endif; ?>
      ...
      <div id="content" class="<?php if ($content_header) { print 'with-content_header'; } ?>"><div id="content-inner">
        ...
        <?php if ($breadcrumb || $title || $tabs || $help || $messages): ?>
          <div id="content-header">
			<?php if ($breadcrumb && !$is_front):?>
				<!--<div class="breadcrumb">  <?php print $breadcrumb; ?> </div> whx隐藏面包屑-->
			<?php endif; ?>
          <?php if ($title && !$is_front && $node->type != 'book_100_classics' && $node->type != 'tu2shu1chan3pin3' && $node->type != 'panel' && $node->type != 'og_group' && $node->nid != 10317 && $node->nid != 154 && $node->nid != 22022 && $node->nid != 10395 && $node->nid != 50487): ?>
		...
		<!-- content_top 与 content-header 调换位置，使测试分类推荐题的图片区块在本node的下面。 -->
		<div id="quiz-taxomory-content">
		
		
		<?php if ($content_top): ?>
          <div id="taxomory-content-top" class="region region-content_top">
		...
		</div><!-- /#quiz-taxomory-content 此div是whx修改添加 -->
