        ...
        <div id="content-inner" class="inner column center">
          ...
          <div id="content-area">
                ...
                <div id="sildeshow">
					...
					<?php $block = module_invoke('block', 'block', 'view', 80); ?>	
					<?php print $block['subject'].$block['content']; ?>
							
        </div>   
		<div id="remen" class="clearfix">
                 <div id="rementitle"><span class="remen">热门文章</span></div>
                 <div id="zhongdianwenzi">
                      <? print views_embed_view('page_front',$display_id = 'attachment_2');?>
                 </div>
                 <div id="zhongdianfenlei">
                      <? print views_embed_view('page_front',$display_id = 'attachment_1');?>
                 </div>
		</div>
                 <div id="zuixinwenzhang">
                      <? print views_embed_view('page_front',$display_id = 'page_2');?>
                 </div>
      ...
      <?php endif; ?>
			...
			<script type="text/javascript">
				$(function(){
					...
					$('#primary li.menu-42342 a').addClass('active');
				});
			</script>
	<script type="text/javascript">
