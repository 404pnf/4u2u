 ...
 */
$db_url['default']  = 'mysql://woshiguanliyuan:ef5abfb553fab28a3d9@localhost/t';
...
ini_set('session.cache_expire',     360000000);
ini_set('session.cache_limiter',    'none');
ini_set('session.cookie_lifetime',  360000000);
...
$conf = array(
	'swftools_media_url' => 'http://2u4u.com.cn/sites/ebook.2u4u.com.cn/files'	
);
# $conf = array(
