    ...
    <?php endif; ?>
      ...
      <div id="content" class="<?php if ($content_header) { print 'with-content_header'; } ?>"><div id="content-inner">
        ...
        <?php if ($breadcrumb || $title || $tabs || $help || $messages): ?>
          ...
          <?php if ($title && !$is_front && $node->type != 'book_100_classics' && $node->type != 'tu2shu1chan3pin3' && $node->type != 'panel' && $node->type != 'og_group' && $node->nid != 10317 && $node->nid != 154 && $node->nid != 22022 && $node->nid != 10395): ?>
          <?php endif; ?>
            <?php print $messages; ?>
            <?php if ($tabs): ?>
