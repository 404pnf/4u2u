    ...
    <div id="main" class="clearfix">
	  ...
	  <div id="content-area">
		...
		<div id="zhongdiantuijian" class="clearfix">
			...
			<div id="zhongdian">
                          <? print views_embed_view('whx_yuedu', $display_id = 'attachment_9');?>
			</div>
			
		  <div id="zhongdianfenlei">
							  <? print views_embed_view('whx_yuedu',$display_id = 'attachment_10');?>
		  </div>
	  </div>
        <div id="xilietushu" class="view-whx-yuedu">        <!-- 系列图书 -->  
	                            <? print views_embed_view('whx_yuedu', $display_id = 'attachment_1');?> 
				</div>
				
				<div id="zhuantituijian" class="view-whx-yuedu"> 
					<? print views_embed_view('whx_yuedu', $display_id = 'attachment_6');?> 
				</div>
            </div>
