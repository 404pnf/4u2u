...
function taiyanghua_settings($saved_settings, $subtheme_defaults = array()) {
  ...
  $form['taiyanghua_breadcrumb']['taiyanghua_breadcrumb'] = array(
    '#type'          => 'select',
  ...
  $form['taiyanghua_breadcrumb']['taiyanghua_breadcrumb_separator'] = array(
    '#type'          => 'textfield',
  ...
  $form['taiyanghua_breadcrumb']['taiyanghua_breadcrumb_home'] = array(
    '#type'          => 'checkbox',
    '#title'         => t('Show home page link in breadcrumb'),
    '#default_value' => $settings['taiyanghua_breadcrumb_home'],
  );
  $form['taiyanghua_breadcrumb']['taiyanghua_breadcrumb_trailing'] = array(
    '#type'          => 'checkbox',
    '#title'         => t('Append a separator to the end of the breadcrumb'),
    '#default_value' => $settings['taiyanghua_breadcrumb_trailing'],
    '#description'   => t('Useful when the breadcrumb is placed just before the title.'),
  );
  $form['taiyanghua_breadcrumb']['taiyanghua_breadcrumb_title'] = array(
    '#type'          => 'checkbox',
