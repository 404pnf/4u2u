                    ...
                    <div id="mobile_dl" class="dlmain">
                      <div id="mobile_title" class="dltitle">
                        <div class="dlname">
						  ...
						  <?php global $user;
						if ($user->uid==826) : ?>
						  <span style="font-size: 12px; float: right; padding-right: 20px;"><a href="/node/add/product-dl-free">创建学习机资源</a></span>
						  <span style="font-size: 12px; float: right; padding-right: 20px;"><a href="/node/add/product-dl">创建手机资源</a></span>
						  <?php endif; ?>
                        </div>
                      </div>
                        ...
                        <div id="tab_area1" class="dlcontent tab_area" >
                          <ul id="dl-tabs0" class="dl-tabs">
                            ...
                            <li id="tab1" class="tabs active">
                              <a href="/dlprice/2" target="_blank">2元专区</a>
                            </li>
							...
							<li class="tab_label">
								<a href="/download/9974" target="_blank">查看所有产品</a>
							</li>
                          </ul>
                          <div id="dl-panes0" class="dl-panes clear">
							<div id="pane_tab1" class="pane">
                              <? print views_embed_view('product_dl', $display_id = 'attachment_1');?>
								...
								<span><img src="/sites/shop.2u4u.com.cn/themes/shop/css/fp_images/2yuan.gif"/></span>
                            ...
                            <div id="pane_tab2" class="pane">
                              <? print views_embed_view('product_dl', $display_id = 'attachment_2');?>
								...
								<span><img src="/sites/shop.2u4u.com.cn/themes/shop/css/fp_images/10yuan.gif"/></span>
							...
							<div id="pane_tab3" class="pane">
                              <? print views_embed_view('product_dl', $display_id = 'attachment_3');?>
								...
								<span><img src="/sites/shop.2u4u.com.cn/themes/shop/css/fp_images/mianfei.gif"/></span>
		...
		<div id="closure_region">
			...
			<script type="text/javascript">
				$(function(){
					...
					$('#primary li a:[href^=http://shop.2u4u.com.cn]').addClass('active');
				});
			</script>
		</div>
	<?php endif; ?>
