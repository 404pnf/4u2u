<div class="node <?php print $classes; ?>" id="node-<?php print $node->nid; ?>">
  <div class="node-inner">
    ...
    <div class="content clear">
      ...
      <?php print $node->content[take]['#value'] ?>
      <?php //print $content; ?>
    </div>
      ...
      <a class="shareto_button" href="http://shareto.com.cn/share.html"><img src="http://video.2u4u.com.cn/sites/video.2u4u.com.cn/themes/video/css/shipin_images/shareto.gif" alt="分享到" style="border:0"/></a>
